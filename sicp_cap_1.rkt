...
(define (guess-is-better? guess prev-guess)
  (< (abs(- 1 (/ prev-guess guess))) 0.000000001)
  )
...
;; Section 1.2: Linear Recursion and Iteration
;; Examples with factorial function:
;; Linear recursion:
(define (factorial-lrec n)
  (if (= n 1)
      1
      (* n (factorial-lrec (- n 1))
      )
   )
 )
